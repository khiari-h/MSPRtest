		...
		<div id="containerWrapper">
			<ul class="supsystic-bar-controls">
				<li title="<?php _e('Add Category', GMP_LANG_CODE)?>">
					<a class="button button-table-action" id="addMarkerGroup" href="<?php echo esc_attr($this->_getPageLink('marker_groups_add_new'))?>">
						<?php _e('Add Category', GMP_LANG_CODE)?>
					</a>
				</li>
				<li title="<?php _e('Options', GMP_LANG_CODE)?>">
					<a class="button button-table-action" id="markerGroupOptions" href="<?php echo esc_attr($this->_getPageLink('marker_groups_options'))?>">
