				...
				<tr>
					...
					<td>
						...
						<?php echo htmlGmp::ajaxfile('csv_import_file_maps', array(
							'url' => uriGmp::_(array('baseUrl' => admin_url('admin-ajax.php'), 'page' => 'csv', 'action' => 'import', 'type' => 'maps', 'reqType' => 'ajax', '_wpnonce' => wp_create_nonce('gmp_nonce'))),
				...
				<tr>
					...
					<td>
						...
						<?php echo htmlGmp::ajaxfile('csv_import_file_markers', array(
							'url' => uriGmp::_(array('baseUrl' => admin_url('admin-ajax.php'), 'page' => 'csv', 'action' => 'import', 'type' => 'markers', 'reqType' => 'ajax', '_wpnonce' => wp_create_nonce('gmp_nonce'))),
							'data' => 'gmpCsvImportData',
							'buttonName' => __('Import', GMP_LANG_CODE),
							'responseType' => 'json',
							'onSubmit' => 'gmpCsvImportOnSubmit',
				...
				<tr>
					...
					<td>
						...
						<?php echo htmlGmp::ajaxfile('csv_import_file_figures', array(
							'url' => uriGmp::_(array('baseUrl' => admin_url('admin-ajax.php'), 'page' => 'csv', 'action' => 'import', 'type' => 'figures', 'reqType' => 'ajax', '_wpnonce' => wp_create_nonce('gmp_nonce'))),
							'data' => 'gmpCsvImportData',
							'buttonName' => __('Import', GMP_LANG_CODE),
							'responseType' => 'json',
							'onSubmit' => 'gmpCsvImportOnSubmit',
				...
				<tr>
					...
					<td>
						...
						<?php echo htmlGmp::ajaxfile('csv_import_file_heatmap', array(
							'url' => uriGmp::_(array('baseUrl' => admin_url('admin-ajax.php'), 'page' => 'csv', 'action' => 'import', 'type' => 'heatmap', 'reqType' => 'ajax', '_wpnonce' => wp_create_nonce('gmp_nonce'))),
							'data' => 'gmpCsvImportData',
							'buttonName' => __('Import', GMP_LANG_CODE),
							'responseType' => 'json',
							'onSubmit' => 'gmpCsvImportOnSubmit',
